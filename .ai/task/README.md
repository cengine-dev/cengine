...
| 30 | [A cengine se publica para UM consumidor só (e tem dois)](30-dependencia-partida.md) | ✅ **fechada em NEGATIVO** (2026-09-13): os 12 jogos não serão tocados, então o defeito não tem evento que o exponha. O padrão que sobrou está em uso no `diorama` | Build |
